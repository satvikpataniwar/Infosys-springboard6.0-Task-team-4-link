...
# CONFIG
# --------------------------
DATA_ROOT = r"/content/drive/MyDrive/archive (2)/ShanghaiTech/part_A"
IMG_SZ = (256,256)
BATCH = 8
EPOCHS = 50
LR = 1e-5
...
import os
os.environ["TWILIO_SID"] = "AC7b2bd590a6d896875f691b3505338f11"
os.environ["TWILIO_TOKEN"] = "3412280404c45d88c7590e1678dd51ed"
os.environ["TWILIO_FROM"] = "+12722219693"
os.environ["ALERT_PHONE"] = "+919618679738"

os.environ["EMAIL_USER"] = "pataniwarsatvik2@gmail.com"
os.environ["EMAIL_PASS"] = "cemsxrdbevsvrivy"
os.environ["ALERT_EMAIL"] = "pataniwarsatvik2@gmail.com"

os.environ["NGROK_AUTH_TOKEN"] = "33QcdaomE7kto6b49acDs2F2RTt_81a46HzAw5D1Ys5j3EQuS"   # optional but recommended
...
ngrok.set_auth_token("33QcdaomE7kto6b49acDs2F2RTt_81a46HzAw5D1Ys5j3EQuS")
